...
function vbmenu_doregister(controlid, nowrite, datefield)
{
	if (document.getElementsByTagName)
	{
		...
		{			
			...
			if (!nowrite)
			{
				document.write('<img src="../images/lupa3.gif" alt="" border="0" />');
			}
			return true;
		}
	}
...
if(whichform.findthis.value!=null && whichform.findthis.value!='') {
       ...
       //str = document.frm.findthis.value;
       //win = ifrm.document.frm;
...
//   TestRange=ifrm.document.body.createTextRange();
   TestRange=whichframe.document.body.createTextRange();
...
//        ifrm.document.body.scrollTop = ifrm.document.body.scrollTop + TRange.offsetTop;
        whichframe.document.body.scrollTop = whichframe.document.body.scrollTop + TRange.offsetTop;
        TRange.select();
        }
...
//     TRange=ifrm.document.body.createTextRange();
     TRange=whichframe.createTextRange();
     TRange.collapse(false);
     strFound=TRange.findText(str);
     if (strFound) {
        //the following line added by Mike and Susan Keenan, 7 June 2003
//        ifrm.document.body.scrollTop = TRange.offsetTop;
        whichframe.document.body.scrollTop = TRange.offsetTop;
        TRange.select();
        }
...
//   TRange=ifrm.document.body.createTextRange();
   TRange=whichframe.document.body.createTextRange();
...
//        ifrm.document.body.scrollTop = TRange.offsetTop;
  ...
  if (!strFound) alert ("Texto '"+str+"' no encontrado!") // string not found
        
}

//////////////////////////////////////////////////////////////////////////// -->
function ordenar(tabla, campo, ordenado)
	{
		var fd = ifrm.document.frm;
		var fdc = ifrmcab.document.frm;
		var d = document.frm;
		var d2 = document.frmbusq;
		fd.tabla.value = tabla
		fd.campo.value = campo
		fdc.campo.value = campo
		fd.ordenado.value = ordenado
		fd.submit();
		fdc.submit();
		TRange = null;
		dupeRange = null;
...
function nuevo2()
{
	...
	parent.document.frm.elements[0].value = "";
	parent.document.frm.elements[1].focus();
	TRange = null;
	dupeRange = null;
	TestRange = null;
	win = null;
