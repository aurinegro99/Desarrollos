...
var treeMenuFgColor    = "#000066";       // Color for menu item text.
var treeMenuHiBg       = "#ffffff";       // Color for selected item background.
var treeMenuHiFg       = "#ff0000";       // Color for selected item text.
var treeMenuFont       = 
      "MS Sans Serif,Arial,Helvetica";    // Text font face.
var treeMenuFontSize   = 1;               // Text font size.
var treeMenuRoot       = "SCAA";     // Text for the menu root.
...
treeMenu.addItem(new TreeMenuItem("Mantención Maestros"));
...
treeMenu.addItem(new TreeMenuItem("Contact BrainJar.com", "/contact.asp", "_blank"));
treeMenu.addItem(new TreeMenuItem("FAQs", "/faqs.html", "_blank"));
treeMenu.addItem(new TreeMenuItem("Search", "/search.asp", "_blank"));
treeMenu.addItem(new TreeMenuItem("What's New", "/new.html", "_blank"));

// ASP submenu.

var asp = new TreeMenu();
asp.addItem(new TreeMenuItem("Datos Configuración"));
asp.addItem(new TreeMenuItem("Sites"));
asp.addItem(new TreeMenuItem("Code Examples99"));
asp.addItem(new TreeMenuItem("Sites99"));
treeMenu.items[0].makeSubmenu(asp);

// ASP Code Examples submenu.

var asp_ex = new TreeMenu();
asp_ex.addItem(new TreeMenuItem("Datos Generales", "", "mainFrame","meni_link_external.gif"));
...
asp_ex.addItem(new TreeMenuItem("Form Validation", "/asp/validation.html", "mainFrame"));
asp_ex.addItem(new TreeMenuItem("Last Modified Timestamp", "/asp/lastmod.html", "mainFrame"));
...
var pp = new TreeMenu();
pp.addItem(new TreeMenuItem("Paises", "paises_new.php", "mainFrame","menu_link_java.gif"));
pp.addItem(new TreeMenuItem("Tipo Equipo", "tipo_equipo.php", "mainFrame"));
pp.addItem(new TreeMenuItem("Componentes", "componentes.php", "mainFrame"));
pp.addItem(new TreeMenuItem("Posiciones", "posiciones.php", "mainFrame"));
asp_ex.items[0].makeSubmenu(pp);
...
dhtml_ex.addItem(new TreeMenuItem("Navigation Bar", "/dhtml/navbar/", "_blank"));
dhtml_ex.addItem(new TreeMenuItem("Pop-Up Menus", "/dhtml/popupmenu/", "_blank"));
...
js_ex.addItem(new TreeMenuItem("Year 2001 Countdown", "/js/y2k.html", "mainFrame"));
