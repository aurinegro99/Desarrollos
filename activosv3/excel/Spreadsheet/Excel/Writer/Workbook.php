...
if (!class_exists('Spreadsheet_Excel_Writer_BIFFwriter')) {
    require_once '../excel/Spreadsheet/Excel/Writer/Format.php';
    require_once '../excel/Spreadsheet/Excel/Writer/BIFFwriter.php';
    require_once '../excel/Spreadsheet/Excel/Writer/Worksheet.php';
    require_once '../excel/Spreadsheet/Excel/Writer/Parser.php';
}
