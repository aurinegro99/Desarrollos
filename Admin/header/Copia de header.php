...
<html>
<head>
	<title>Sistema Control Análisis Aceite SCAA  Komatsu Chile S.A.</title>
<style>
...
*************************************/
oCMenu.makeMenu('top0','','&nbsp;Mantención','','',160,0)
  oCMenu.makeMenu('sub00','top0','Configuración Maestros','','',160,0)
    ...
    oCMenu.makeMenu('sub002','sub00','Datos Especificos','','',160,0)
		oCMenu.makeMenu('sub0005','sub002','- Compañias','companias.php','',160,0)
	...
	oCMenu.makeMenu('sub003','sub00','Asociación Maestros','','',160,0)
  ...
  oCMenu.makeMenu('sub01','top0','Gestión Usuario','','',160,0)
  oCMenu.makeMenu('sub02','top0','Configuración SCAA','','',160,0)
    oCMenu.makeMenu('sub021','sub02','Datos Generales','','',160,0)
	    oCMenu.makeMenu('sub00211','sub021','- Maestro Elementos Análisis','elementos.php','',175,0)
		oCMenu.makeMenu('sub00212','sub021','- Laboratorios Análisis','laboratorios.php','',175,0)
	...
	oCMenu.makeMenu('sub022','sub02','Asociación Datos SCAA','','',160,0)
		...
		oCMenu.makeMenu('sub00223','sub022','- Componentes x Elemento Análisis','paises_new.php','',190,0)
